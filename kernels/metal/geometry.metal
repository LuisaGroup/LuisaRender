...
LUISA_KERNEL void geometry_evaluate_interactions(
    ...
    geometry::evaluate_interactions(
        ...
        interaction_state_buffer, interaction_position_buffer, interaction_normal_buffer,
        interaction_uv_buffer, interaction_wo_and_distance_buffer, interaction_instance_id_buffer,
        uniforms, tid.x);
}