...
Float3 L1Instance::loss(const Camera::Instance *camera, const SampledWavelengths &swl) const noexcept {
...
Float3 L1Instance::d_loss(const Camera::Instance *camera, Expr<uint2> pixel_id,
